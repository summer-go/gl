...
int main()
{
    ...
    // -------------------------
    string root("/Users/baidu/CLionProjects/gl");
    Shader ourShader((root + "/shader/anim_model.vert").c_str(), (root + "/shader/anim_model.frag").c_str());
//    Shader ourShader((root + "/shader/1.model_loading.vs").c_str(), (root + "/shader/1.model_loading.fs").c_str());
